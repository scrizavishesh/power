                                                                ...
                                                                <div className="d-flex">
                                                                    {
                                                                        provider?.approval_status !== 'APPROVED' && (
                                                                            <Link to={`/create_fund/${provider?.order_id}/${provider?.receipt}/${provider?.agent}/${provider?.payment_amount}`} className='btn approveButton me-3 align-self-center' type='button'>Pay</Link>
                                                                        )
                                                                    }
                                                                </div>
                                                            </td>
...
export default PeerPayInOperations